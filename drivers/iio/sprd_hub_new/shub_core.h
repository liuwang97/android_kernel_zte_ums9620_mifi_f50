...
/* add under-panel light sensor algo start */
	struct notifier_block shub_algo_cmd_notifier;
	int brightness;
	int actual_fps;
...
/* add for sensorhub init ready start */
	wait_queue_head_t sensorhub_wq;
	bool sensorhub_init_ready;
/* add for sensorhub init ready end */
/* add for sensorhub send sensor infor over start */
	wait_queue_head_t sensorinfo_wq;
	bool sensor_infor_send_over;
/* add for sensorhub send sensor infor over end */
};

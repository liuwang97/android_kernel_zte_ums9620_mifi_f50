...
enum shub_subtype_id {
	...
	SHUB_SEND_SENSORHUB_INIT_READY_SUBTYPE = 0xd0,

	/* add for sensorinfo send over */
	SHUB_SEND_SENSORINFO_OVER_SUBTYPE = 0xd1,

	/* add opcode id for under-panel light sensor start */
	SHUB_SET_BRIGHTNESS_SUBTYPE = 0xe1,
	SHUB_SET_ACTUAL_FPS_SUBTYPE = 0xe2,
	/* add opcode id for under-panel light sensor end */

#ifdef CONFIG_VENDOR_ZTE_LOG_EXCEPTION
	SHUB_ZLOG_I2C_RW_ERROR_SUBTYPE = 0xe3,
	SHUB_ZLOG_SPI_RW_ERROR_SUBTYPE = 0xe4,
	SHUB_ZLOG_ESD_CHECK_TRI_SUBTYPE = 0xe5,
	SHUB_ZLOG_FACTORY_CALI_SUBTYPE = 0xe6,
	SHUB_ZLOG_STEP_COUNTER_DEC_NO = 0xe7,
#endif

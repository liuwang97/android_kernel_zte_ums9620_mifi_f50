...
static int sqc_hal_init_pmic_charger(int chg_pos)
{
...
static int sqc_hal_get_chg_type(int chg_pos, unsigned int *chg_type)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
	...
	for (i = 0; i < SQC_MAX_CHARGER_NUM; i++) {
		...
		if ((chg_pos & BIT(i)) &&
					(pmic_ops != NULL) &&
					(pmic_ops->get_chg_type != NULL)) {
			pr_debug("chg_pos: %d\n", i);
			retval |= pmic_ops->get_chg_type(pmic_ops->arg, chg_type);
		}
	}
...
static int sqc_hal_charging_enable_set(int chg_pos, bool enable)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_charging_enable_get(int chg_pos, unsigned int *enabled)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_set_chging_fcv(int chg_pos, unsigned int mV)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_get_chging_fcv(int chg_pos, unsigned int *mV)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_set_chging_fcc(int chg_pos, unsigned int mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_get_chging_fcc(int chg_pos, unsigned int *mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_set_chging_icl(int chg_pos, unsigned int mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_get_chging_icl(int chg_pos, unsigned int *mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_set_chging_topoff(int chg_pos, unsigned int mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_get_chging_topoff(int chg_pos, unsigned int *mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_set_rechg_soc(int chg_pos, unsigned int rechg_soc)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_get_rechg_soc(int chg_pos, unsigned int *rechg_soc)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_set_rechg_volt(int chg_pos, unsigned int rechg_volt_mv)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_get_rechg_volt(int chg_pos, unsigned int *rechg_volt_mv)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_get_charing_status(int chg_pos, unsigned int *chg_status)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_get_interrupt_status(int chg_pos, unsigned int *int_status)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_charging_role_set(int chg_pos, unsigned int master)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_charging_role_get(int chg_pos, unsigned int *master)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_batt_ovp_voltage_set(int chg_pos, unsigned int mV)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_batt_ovp_voltage_get(int chg_pos, unsigned int *mV)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_batt_ovp_alarm_voltage_set(int chg_pos, unsigned int mV)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_batt_ovp_alarm_voltage_get(int chg_pos, unsigned int *mV)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_batt_ocp_current_set(int chg_pos, unsigned int mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_batt_ocp_current_get(int chg_pos, unsigned int *mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_batt_ocp_alarm_current_set(int chg_pos, unsigned int mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_batt_ocp_alarm_current_get(int chg_pos, unsigned int *mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_batt_ucp_alarm_current_set(int chg_pos, unsigned int mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_batt_ucp_alarm_current_get(int chg_pos, unsigned int *mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_ac_ovp_voltage_set(int chg_pos, unsigned int mV)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_ac_ovp_voltage_get(int chg_pos, unsigned int *mV)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_usb_ovp_voltage_set(int chg_pos, unsigned int mV)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_usb_ovp_voltage_get(int chg_pos, unsigned int *mV)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_usb_ovp_alarm_voltage_set(int chg_pos, unsigned int mV)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_usb_ovp_alarm_voltage_get(int chg_pos, unsigned int *mV)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_usb_ocp_current_set(int chg_pos, unsigned int mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_usb_ocp_current_get(int chg_pos, unsigned int *mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_usb_ocp_alarm_current_set(int chg_pos, unsigned int mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_usb_ocp_alarm_current_get(int chg_pos, unsigned int *mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_usb_ibus_get(int chg_pos, unsigned int *mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_usb_vbus_get(int chg_pos, unsigned int *mV)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_usb_ibat_get(int chg_pos, unsigned int *mA)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_usb_vbat_get(int chg_pos, unsigned int *mV)
{
	struct sqc_pmic_chg_ops *pmic_ops = NULL;
	int i = 0, retval = 0;
...
static int sqc_hal_powerpath_set(int chg_pos, int enabled)
{
	...
	for (i = 0; i < SQC_MAX_CHARGER_NUM; i++) {
		...
		if ((chg_pos & BIT(i)) &&
					(pmic_ops != NULL) &&
					(pmic_ops->enable_path_set != NULL)) {
			pr_debug("chg_pos: %d\n", i);
			retval |= pmic_ops->enable_path_set(pmic_ops->arg, enabled);
		}
	}
...
static int sqc_hal_hiz_set(int chg_pos, int enabled)
{
	...
	for (i = 0; i < SQC_MAX_CHARGER_NUM; i++) {
		...
		if ((chg_pos & BIT(i)) &&
					(pmic_ops != NULL) &&
					(pmic_ops->enable_hiz_set != NULL)) {
			pr_debug("chg_pos: %d\n", i);
			retval |= pmic_ops->enable_hiz_set(pmic_ops->arg, enabled);
		}
	}
...
static int sqc_hal_hiz_get(int chg_pos, int *enabled)
{
	...
	for (i = 0; i < SQC_MAX_CHARGER_NUM; i++) {
		...
		if ((chg_pos & BIT(i)) &&
					(pmic_ops != NULL) &&
					(pmic_ops->enable_hiz_get != NULL)) {
			pr_debug("chg_pos: %d\n", i);
			retval |= pmic_ops->enable_hiz_get(pmic_ops->arg, enabled);
		}
	}
...
{
	ssize_t retval = 0;
	unsigned int chg_pos = 0, file_pos = 0, temp_val = 0;
	...
	chg_pos = (*f_pos) / SQC_IFS_DIVISION;
	file_pos = (*f_pos) % SQC_IFS_DIVISION;

	mutex_lock(&(chg_hal_data.file_mutex));

	switch (file_pos) {
	case SQC_IFS_PMIC_TYPE_GET:
		retval = sqc_hal_get_chg_type(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_STATUS_GET:
		retval = sqc_hal_get_charing_status(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_INT_GET:
		retval = sqc_hal_get_interrupt_status(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_ENABLE:
		retval = sqc_hal_charging_enable_get(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_FCV:
		retval = sqc_hal_get_chging_fcv(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_FCC:
		retval = sqc_hal_get_chging_fcc(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_ICL:
		retval = sqc_hal_get_chging_icl(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_TOPOFF:
		retval = sqc_hal_get_chging_topoff(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_RECHG_SOC:
		retval = sqc_hal_get_rechg_soc(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_RECHG_VOLT:
		retval = sqc_hal_get_rechg_volt(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_ROLE:
		retval = sqc_hal_charging_role_get(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_BATT_OVP:
		retval = sqc_hal_batt_ovp_voltage_get(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_BATT_OVP_ALM:
		retval = sqc_hal_batt_ovp_alarm_voltage_get(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_BATT_OCP:
		retval = sqc_hal_batt_ocp_current_get(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_BATT_OCP_ALM:
		retval = sqc_hal_batt_ocp_alarm_current_get(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_BATT_UCP_ALM:
		retval = sqc_hal_batt_ucp_alarm_current_get(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_AC_OVP:
		retval = sqc_hal_ac_ovp_voltage_get(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_USB_OVP:
		retval = sqc_hal_usb_ovp_voltage_get(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_USB_OVP_ALM:
		retval = sqc_hal_usb_ovp_alarm_voltage_get(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_USB_OCP:
		retval = sqc_hal_usb_ocp_current_get(chg_pos, &temp_val);
		break;
	case SQC_IFS_PMIC_USB_OCP_ALM:
		retval = sqc_hal_usb_ocp_alarm_current_get(chg_pos, &temp_val);
		break;
	case SQC_IFS_VBUS_NOW:
		retval = sqc_hal_usb_vbus_get(chg_pos, &temp_val);
		break;
	case SQC_IFS_IBUS_NOW:
		retval = sqc_hal_usb_ibus_get(chg_pos, &temp_val);
		break;
	case SQC_IFS_VBAT_NOW:
		retval = sqc_hal_usb_vbat_get(chg_pos, &temp_val);
		break;
	case SQC_IFS_IBAT_NOW:
		retval = sqc_hal_usb_ibat_get(chg_pos, &temp_val);
		break;
	case SQC_IFS_POWERPATH_ENABLE:
		retval = sqc_hal_powerpath_get(chg_pos, &temp_val);
		break;
	case SQC_IFS_ENABLE_HIZ:
		retval = sqc_hal_hiz_get(chg_pos, &temp_val);
		break;
	default:
		retval = -ENOMEM;
	...
	/*pr_info("%s chg_pos 0x%02X, file_pos %d, temp_val %d.!\n", __func__, chg_pos, file_pos, temp_val);*/
			     ...
			     size_t count, loff_t *f_pos)
{
	...
	case SQC_IFS_PMIC_INIT:
		retval = sqc_hal_init_pmic_charger(chg_pos);
		break;
	case SQC_IFS_PMIC_ENABLE:
		retval = sqc_hal_charging_enable_set(chg_pos, temp_val);
		break;
	case SQC_IFS_PMIC_FCV:
		retval = sqc_hal_set_chging_fcv(chg_pos, temp_val);
		break;
	case SQC_IFS_PMIC_FCC:
		retval = sqc_hal_set_chging_fcc(chg_pos, temp_val);
		break;
	case SQC_IFS_PMIC_ICL:
		retval = sqc_hal_set_chging_icl(chg_pos, temp_val);
		break;
	case SQC_IFS_PMIC_TOPOFF:
		retval = sqc_hal_set_chging_topoff(chg_pos, temp_val);
		break;
	case SQC_IFS_PMIC_RECHG_SOC:
		retval = sqc_hal_set_rechg_soc(chg_pos, temp_val);
		break;
	case SQC_IFS_PMIC_RECHG_VOLT:
		retval = sqc_hal_set_rechg_volt(chg_pos, temp_val);
		break;
	case SQC_IFS_PMIC_ROLE:
		retval = sqc_hal_charging_role_set(chg_pos, temp_val);
		break;
	case SQC_IFS_PMIC_BATT_OVP:
		retval = sqc_hal_batt_ovp_voltage_set(chg_pos, temp_val);
		break;
	case SQC_IFS_PMIC_BATT_OVP_ALM:
		retval = sqc_hal_batt_ovp_alarm_voltage_set(chg_pos, temp_val);
		break;
	case SQC_IFS_PMIC_BATT_OCP:
		retval = sqc_hal_batt_ocp_current_set(chg_pos, temp_val);
		break;
	case SQC_IFS_PMIC_BATT_OCP_ALM:
		retval = sqc_hal_batt_ocp_alarm_current_set(chg_pos, temp_val);
		break;
	case SQC_IFS_PMIC_BATT_UCP_ALM:
		retval = sqc_hal_batt_ucp_alarm_current_set(chg_pos, temp_val);
		break;
	case SQC_IFS_PMIC_AC_OVP:
		retval = sqc_hal_ac_ovp_voltage_set(chg_pos, temp_val);
		break;
	case SQC_IFS_PMIC_USB_OVP:
		retval = sqc_hal_usb_ovp_voltage_set(chg_pos, temp_val);
		break;
	case SQC_IFS_PMIC_USB_OVP_ALM:
		retval = sqc_hal_usb_ovp_alarm_voltage_set(chg_pos, temp_val);
		break;
	case SQC_IFS_PMIC_USB_OCP:
		retval = sqc_hal_usb_ocp_current_set(chg_pos, temp_val);
		break;
	case SQC_IFS_PMIC_USB_OCP_ALM:
		retval = sqc_hal_usb_ocp_alarm_current_set(chg_pos, temp_val);
		break;
	case SQC_IFS_POWERPATH_ENABLE:
		retval = sqc_hal_powerpath_set(chg_pos, temp_val);
		break;
	case SQC_IFS_ENABLE_HIZ:
		retval = sqc_hal_hiz_set(chg_pos, temp_val);
		break;
	default:
		retval = -ENOMEM;
		pr_err("%s f_pos default!\n", __func__, *f_pos);
...
int sqc_hal_charger_register(struct sqc_pmic_chg_ops *ops, int chg_pos)
{
	int ret = 0, sqc_pd_major = 0;
	dev_t sqc_chg_devno;
	struct device *device_ptr = NULL;

	if ((ops == NULL) || (chg_hal_data.chg_ops[chg_pos] != NULL)) {
	...
	chg_hal_data.chg_ops[chg_pos] = ops;

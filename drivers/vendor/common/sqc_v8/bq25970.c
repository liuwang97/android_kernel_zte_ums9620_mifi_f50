...
static int bq25970_get_chg_type(void *arg, unsigned int *chg_type)
{
	arg = arg ? arg : NULL;
...
static struct sqc_pmic_chg_ops bq25970_chg_ops = {
	...
	.get_chg_type = bq25970_get_chg_type,
	.chg_enable = bq25970_set_enable_chg,
	.chg_enable_get = bq25970_get_enable_chg,

	.get_chg_status = bq25970_get_chg_status,
	...
	const struct i2c_device_id *id)
{
	...
	bq_info("dtsmode=%ld, addr=0x%02X\n", chip->hw_mode, client->addr);

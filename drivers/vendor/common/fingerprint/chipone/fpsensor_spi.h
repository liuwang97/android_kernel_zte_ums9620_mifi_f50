...
typedef enum fpsensor_key_event {
    ...
    FPSENSOR_KEY_POWER,
#ifdef CONFIG_CHIPONE_NAV_NEW
    FPSENSOR_KEY_RIGHT = 106,
    FPSENSOR_KEY_UP = 103,
    FPSENSOR_KEY_DOWN = 108,
    FPSENSOR_KEY_LEFT = 105,
#elif defined CONFIG_CHIPONE_NAV_NEW_NEW
    FPSENSOR_KEY_RIGHT = 105,
    FPSENSOR_KEY_UP = 108,
    FPSENSOR_KEY_DOWN = 103,
    FPSENSOR_KEY_LEFT = 106,
#elif defined CONFIG_CHIPONE_NAV_NEW_NEW_NEW
    FPSENSOR_KEY_RIGHT = 103,
    FPSENSOR_KEY_UP = 105,
    FPSENSOR_KEY_DOWN = 106,
    FPSENSOR_KEY_LEFT = 108,
#else
...
typedef struct {
    ...
    /* 0 fingerprint use system gpio control  power, 1 pmic/vddcammot power */
    int power_type;

...
#define SEMI_TOUCH_PROC_DIR                 "touchscreen_semi"
#define SEMI_TOUCH_SYS_DIR                 "touchscreen_semi"
...
#define semi_touch_wake_lock()              0
#define semi_touch_gesture_report(x)        true
#endif

...
#include "gcore_firmware_config_v3.h"
...
/*----------------------------------------------------------*/
#define TOUCH_DRIVER_RELEASE_VERISON   ("3.3.1")
...
#ifdef CONFIG_CB_SIZE
#define CB_SIZE						CONFIG_CB_SIZE
#else
#define CB_SIZE						(1290)
#endif
...
extern unsigned long time_after_fw_upgrade;
...
#define DEFAULT_UPDATE_FIRMWARE_NAME  gcore_default_firmware_name
extern char gcore_default_firmware_name[];
#endif

		...
		char __user *buffer, size_t count, loff_t *ppos)
{
	...
	case CTS_TOOL_CMD_READ_ICTYPE:
		...
		if (cts_dev->hwdata) {
			...
			case CTS_DEV_HWID_ICNL9911: cmd->data[0] = 0x91;
				break;
			case CTS_DEV_HWID_ICNL9911S: cmd->data[0] = 0x91;
				break;
			case CTS_DEV_HWID_ICNL9911C: cmd->data[0] = 0x91;
				break;
			default:  cmd->data[0] = 0x00;
				break;
			}
		} else {
			cmd->data[0] = 0x10;
...
static const struct file_operations cts_tool_fops = {
	.owner = THIS_MODULE,
	.llseek = no_llseek,
	.open  = cts_tool_open,
	.read  = cts_tool_read,

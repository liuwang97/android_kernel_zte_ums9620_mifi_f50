...
int atsha204a_verify_key(const struct i2c_client *i2c, const u8 *key, u8 slot)
{
	...
	//memcpy(mac_param.key, key, sizeof(key));
    //mac_param.key = key;
    mac_param.otp = NULL;
    mac_param.sn = NULL;

...
#define BQ2597X_IBAT_OCP_ALARM_THRESHOLD_INIT    (8000)  /* 10a */
...
#define BQ2597X_AC_OVP_MAX_17000MV         (17000)  /* 18v */
...
#define BQ2597X_VBUS_PD_EN_MASK            (BIT(7))
...
#define BQ2597X_CONV_STAT_FLAG_MASK       (BIT(2))
#define BQ2597X_CONV_STAT_FLAG_SHIFT      (2)
...
#define BQ2597X_CONTROL_REG_INIT           (0x47)
...
#define BQ2597X_WATCHDOG_TIMEOUT_MASK      (BIT(3))
#define BQ2597X_WATCHDOG_TIMEOUT_SHIFT     (3)
...
#define BQ2597X_INT_MASK_REG_INIT          (0xB0)
...
#define BQ2597X_FLT_MASK_REG_INIT          (0x00)
...
#define BQ2597X_DEVICE_ID_BQ25970          (0x00)
#define BQ2597X_DEVICE_ID_SY6537C          (0x0E)

/* ADC_CTRL reg=0x14 */
#define BQ2597X_ADC_CTRL_REG               0x14
#define BQ2597X_ADC_CTRL_REG_INIT          (0xB0)
#define BQ2597X_ADC_CTRL_REG_EXIT          (0x00)
...
#define BQ2597X_ADC_FN_DIS_REG_INIT_MASTER (0x0E)
#define BQ2597X_ADC_FN_DIS_REG_INIT_SLAVE  (0x1E)
...
#define BQ2597X_SS_TIMEOUT_SET_MASK         (BIT(7) | BIT(6) | BIT(5))
#define BQ2597X_SS_TIMEOUT_SET_SHIFT        (5)
#define BQ2597X_EN_REGULATION_MASK          (BIT(4))
#define BQ2597X_EN_REGULATION_SHIFT         (4)
#define BQ2597X_VOUT_OVP_DIS_MASK           (BIT(3))
#define BQ2597X_VOUT_OVP_DIS_SHIFT          (3)
#define BQ2597X_IBUS_UCP_RISE_MASK          (BIT(2))
#define BQ2597X_IBUS_UCP_RISE_SHIFT         (2)
#define BQ2597X_IBAT_SNS_RES_MASK           (BIT(1))
#define BQ2597X_IBAT_SNS_RES_SHIFT          (1)
#define BQ2597X_IBAT_SNS_RESISTOR_5MOHM          1
#define BQ2597X_IBAT_SNS_RESISTOR_2MOHM          0
#define BQ2597X_IBAT_SNS_RESISTOR_1MOHM          1


#define BQ2597X_VAC_PD_EN_MASK           	(BIT(0))
...
/* PULSE_MODE reg=0x2c */
#define BQ2597X_REG_THRESHOLD_REG             0x2C

#define BQ2597X_IBAT_REG_SET_MASK         	(BIT(7) | BIT(6))
#define BQ2597X_IBAT_REG_SET_SHIFT        	(6)
#define BQ2597X_IBAT_OVP_REG_200MA          0x00
#define BQ2597X_IBAT_OVP_REG_300MA          0x01
#define BQ2597X_IBAT_OVP_REG_400MA          0x02
#define BQ2597X_IBAT_OVP_REG_500MA          0x03

#define BQ2597X_VBAT_REG_SET_MASK         	(BIT(5) | BIT(4))
#define BQ2597X_VBAT_REG_SET_SHIFT        	(4)
#define BQ2597X_VBAT_OVP_REG_50MV           0x00
#define BQ2597X_VBAT_OVP_REG_100MV          0x01
#define BQ2597X_VBAT_OVP_REG_150MA          0x02
#define BQ2597X_VBAT_OVP_REG_200MA          0x03

#define BQ2597X_VBAT_REG_ACTIVE_MASK        (BIT(3))
#define BQ2597X_VBAT_REG_ACTIVE_SHIFT       (3)
#define BQ2597X_IBAT_REG_ACTIVE_MASK        (BIT(2))
#define BQ2597X_IBAT_REG_ACTIVE_SHIFT       (2)
#define BQ2597X_VDROP_OVP_STAT_MASK           (BIT(1))
#define BQ2597X_VDROP_OVP_STAT_SHIFT          (1)
#define BQ2597X_VOUT_OVP_STAT_MASK           	(BIT(0))
#define BQ2597X_VOUT_OVP_STAT_SHIFT          	(0)
